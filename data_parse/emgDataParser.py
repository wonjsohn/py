...
#        fig = plt.figure()
    #    frame = frame.cumsum()a
    #    frame.plot()
        num_of_subplots = 4
        fig, axes = plt.subplots(num_of_subplots, 1, sharex=True, sharey=True)
        axes[0].plot(emg1List,  label = 'index flexor',  color='k')
        axes[1].plot(emg2List,   label = 'middle flexor',  color='k')
        axes[2].plot(emg3List,   label = 'index extensor',  color='k')
        axes[3].plot(emg4List,  label = 'middle extensor',  color='k')
